...
const EverythingYouNeed = () => {
    return (
        <>
            <div className=" py-24 sm:py-18 isolate bg-white">
                        ...
                        <div className="relative lg:row-span-2">
                            ...
                            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
                                <div className="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
                                    <p className="mt-2 text-lg font-medium tracking-tight text-gray-950 max-lg:text-center">Work smarter</p>
                                    <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">From trusted job listings to built-in community guidance, our platform is designed to help you make confident career choices — not blind leaps of faith.</p>
                                </div>
                                <div className="@container relative min-h-120 w-full grow max-lg:mx-auto max-lg:max-w-sm">
                                    <div className="absolute inset-x-10 top-10 bottom-0 overflow-hidden rounded-t-[12cqw] border-x-[3cqw] border-t-[3cqw] border-gray-700 bg-gray-900 shadow-2xl">
                                        <img className="size-full object-cover object-top" src="./worksmarter.png" alt="" />
                                    </div>
                                </div>
                            </div>
